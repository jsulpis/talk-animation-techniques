function C(u){return[(u>>16&255)/255,(u>>8&255)/255,(255&u)/255]}["SCREEN","LINEAR_LIGHT"].reduce((u,o,l)=>Object.assign(u,{[o]:l}),{});class L{constructor(o,l,m,g=!1){const a=this,w=document.location.search.toLowerCase().indexOf("debug=webgl")!==-1;a.canvas=o,a.gl=a.canvas.getContext("webgl",{antialias:!0}),a.meshes=[];const s=a.gl;l&&m&&this.setSize(l,m),a.lastDebugMsg,a.debug=g&&w?function(i){const r=new Date;r-a.lastDebugMsg>1e3&&console.log("---"),console.log(r.toLocaleTimeString()+Array(Math.max(0,32-i.length)).join(" ")+i+": ",...Array.from(arguments).slice(1)),a.lastDebugMsg=r}:()=>{},Object.defineProperties(a,{Material:{enumerable:!1,value:class{constructor(i,r,e={}){const n=this;function d(p,b){const v=s.createShader(p);return s.shaderSource(v,b),s.compileShader(v),s.getShaderParameter(v,s.COMPILE_STATUS)||console.error(s.getShaderInfoLog(v)),a.debug("Material.compileShaderSource",{source:b}),v}function c(p,b){return Object.entries(p).map(([v,f])=>f.getDeclaration(v,b)).join(`
`)}n.uniforms=e,n.uniformInstances=[];const h=`
